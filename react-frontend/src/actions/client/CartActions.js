import { POST, PUT, DELETE } from 'utils/fetchHelper';
...
export function getCart(url, data) {
  return POST(url, data, GET_CART_BEGIN, GET_CART_SUCCESS, GET_CART_ERROR);
}
...
export function deleteTS(url) {
  return DELETE(url, DELETE_CART_BEGIN, DELETE_CART_SUCCESS, DELETE_CART_ERROR);
}
