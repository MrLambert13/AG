...
export const GET_STO_BEGIN = 'GET_STO_BEGIN';
export const GET_STO_SUCCESS = 'GET_STO_SUCCESS';
export const GET_STO_ERROR = 'GET_STO_ERROR';
...
export function getSto(url) {
  return GET(url, GET_STO_BEGIN, GET_STO_SUCCESS, GET_STO_ERROR);
}
